...
export default function TokenSelector(props) {
  ...
  return (
    <Combobox as="div" className={props.className} value={selectedPerson} onChange={setSelectedPerson}>
                ...
                {({ active, selected }) => (
                  <>
                    <div className="flex items-center">
                      <img src={person.imageUrl} alt="" className="h-6 w-6 flex-shrink-0 rounded-full border border-gray-100" />
